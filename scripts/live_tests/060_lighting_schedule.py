...
By default this script does NOT reset learning data so it can run safely after
020_learning_pipeline.py and 030_learning_proposals_diag.py without destroying
presence proposals already generated by those tests.
