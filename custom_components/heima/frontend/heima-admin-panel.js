    ...
    return `
      ...
      <section class="detail-grid">
        ${this._detailSection("Recovery State", {
          ...
          settling_started_at: recovery.settling_started_at,
          degraded_started_at: recovery.degraded_started_at,
          stabilization_deadline_at: recovery.stabilization_deadline_at,
          degraded_timeout_at: recovery.degraded_timeout_at,
